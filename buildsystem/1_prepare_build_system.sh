...
if [ -z "$updatecheck" ] && [ "$FIRMWARE_UPDATE" -ne 0 ]; then
    sudo rpi-update
    echo "############################################################################"
    echo ""
